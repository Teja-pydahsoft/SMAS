...
function AppSidebarWithGateSession({ user, can, logout }) {
  const pathname = usePathname();
  ...
  return <AppSidebarInner user={user} can={can} logout={logout} gateSessionUrl={gateSessionUrl} />;
}
...
export default function AppSidebar() {
  ...
  return (
    <Suspense fallback={null}>
      <AppSidebarWithGateSession user={user} can={can} logout={logout} />
    </Suspense>
  );
}
