...
export const SUPER_ADMIN_NAV_ITEMS = [
  ...
  { path: '/registrations', label: 'Registrations', icon: 'registrations', module: 'registrations' },
  {
    ...
    module: 'jattu',
    children: [
      { path: '/jattu/dashboard', label: 'Dashboard', module: 'jattu' },
      { path: '/registrations?roleSlug=jattu', label: 'Registrations', module: 'jattu_registrations' },
      { path: '/jattu/entry-exit', label: 'Entry & Exit', module: 'jattu_entry_exit' },
      { path: '/jattu/activity', label: 'Activity', module: 'jattu_activity' },
      { path: '/jattu/attendance-history', label: 'Attendance History', module: 'jattu_attendance' },
    ],
  },
  {
    path: '/organization',
